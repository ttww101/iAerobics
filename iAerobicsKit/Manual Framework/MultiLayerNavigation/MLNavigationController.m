...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.canDragBack = (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)?NO:YES;
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    self.sideMenuViewController.backgroundImage = nil;
...
- (UIViewController *)popViewControllerAnimated:(BOOL)animated
{
    ...
    //    NSLog(@"%d",self.screenShotsList.count);
    if (self.screenShotsList.count==1) {
        self.sideMenuViewController.backgroundImage = [UIImage imageNamed:@"aerobicsbg"];
    }
...
- (void)paningGestureReceive:(UIPanGestureRecognizer *)recoginzer
{
    ...
    if (recoginzer.state == UIGestureRecognizerStateBegan) {
        ...
        if (!self.backgroundView)
        {
            ...
            blackMask.backgroundColor = [UIColor colorWithRed:26/255.0 green:188/255.0 blue:156/255.0 alpha:0.8f];
