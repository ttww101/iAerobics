...
- (void)setContainerViewController {
    AerobicsVC *vc1 = [AerobicsVC new];
    [self.mContainerVCArr addObject:vc1];
    FoodVC *vc2 = [FoodVC new];
    [self.mContainerVCArr addObject:vc2];
    CollectionFoodVC *vc3 = [CollectionFoodVC new];
...
- (NSArray<UIImage *> *)tabBarImages {
    return @[[UIImage imageNamed:@"down_button"], [UIImage imageNamed:@"down_button"], [UIImage imageNamed:@"down_button"]];
}

- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:112.0/255.0 green:186.0/255.0 blue:190.0/255.0 alpha:1.0];
}
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //bar color
                              barColor:[UIColor colorWithRed:112.0/255.0 green:186.0/255.0 blue:190.0/255.0 alpha:1.0]
                              //title font, size
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if(section == 0){
        ...
        UIColor *bgColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"aerobicsbg"]];
